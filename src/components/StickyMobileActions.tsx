 ...
 * Call button (left) + WhatsApp button (right, gold).
 */
...
export default function StickyMobileActions() {
  ...
  return (
    ...
    >
      ...
      {/* Divider */}
      <div style={{ width: "1px", backgroundColor: "#1E2A42" }} />
      ...
      >
        <svg className="w-5 h-5" viewBox="0 0 32 32" fill="#080A14" aria-hidden="true">
        ...
        <span className="text-xs font-semibold" style={{ color: "#080A14" }}>
