...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mobile-trust-bar-content flex items-center gap-2">
          <svg width="14" height="14" fill="none" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.56 5.82 22 7 14.14l-5-4.87 6.91-1.01L12 2z" stroke="#C8963E" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" fill="rgba(200,150,62,0.12)" />
          </svg>
      ...
      >
        <div className="mobile-header-row max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                height: 40,
                borderRadius: "50%",
                border: "1.5px solid rgba(200,150,62,0.30)",
                overflow: "hidden",
              }}
            >
              <Image
            ...
            <span
              className="inline-block self-stretch w-px my-1.5 opacity-30"
            ...
            <div className="flex flex-col items-start select-none leading-none">
              ...
              {/* Subtle bottom rule */}
              <span
                className="mt-[5px] block h-px w-full opacity-25"
                style={{ background: "linear-gradient(90deg, #C8963E, transparent)" }}
                aria-hidden="true"
              />
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-6 text-sm font-medium">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Glowing Purple Active / Hover Underline */}
                  <span
            ...
            {/* Visually strong & elegant solid gold Call CTA Button */}
            <a
              href={`tel:${BUSINESS.phone}`}
              id="header-call-btn"
              className="px-5 py-2.5 rounded-lg text-sm font-bold transition-all hover:scale-105 active:scale-95 hover:shadow-[0_0_20px_rgba(200,150,62,0.4)] shrink-0 flex items-center gap-2 cursor-pointer select-none"
              style={{
                backgroundColor: "#C8963E",
                color: "#080A14",
                boxShadow: "0 4px 12px rgba(200, 150, 62, 0.15)",
              }}
            >
          ...
          {/* Mobile controls */}
          <div className="mobile-header-controls flex md:hidden items-center gap-2.5">
            <LanguageSwitcher lang={lang} setLang={setLang} />
            <button
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      backgroundColor: isActive ? "rgba(120, 80, 255, 0.08)" : "transparent",
  ...
  return (
    <div className="mobile-language-switcher relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg border border-[#1E2A42] bg-[#0A0D18] text-xs font-semibold text-[#E2DCD0] hover:text-[#C8963E] hover:border-[#C8963E] transition-all duration-200 cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#C8963E] select-none"
      >
        <span className="leading-none shrink-0" aria-hidden="true">{current.flag}</span>
      ...
      {isOpen && (
        <div
          className="absolute right-0 mt-1.5 w-32 rounded-lg border border-[#1E2A42] bg-[#0A0D18] shadow-[0_4px_20px_rgba(0,0,0,0.6)] focus:outline-none z-50 overflow-hidden"
          role="menu"
        ...
        >
          <div className="py-1" role="none">
            <button
              ...
              className={`flex items-center gap-2.5 w-full text-left px-3 py-2 text-xs font-semibold transition-all duration-150 cursor-pointer ${
                lang === "nl"
