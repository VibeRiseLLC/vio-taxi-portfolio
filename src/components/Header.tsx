        ...
        <div className="mobile-header-row max-w-6xl mx-auto px-4 h-[52px] flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-5 text-[13px] font-medium">
            ...
            <a
              ...
              id="header-call-btn"
              className="px-4 py-2 rounded-md text-[13px] font-bold transition-all hover:brightness-105 active:scale-95 shrink-0 flex items-center gap-2 cursor-pointer select-none"
              style={{
